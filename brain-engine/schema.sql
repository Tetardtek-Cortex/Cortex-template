...
CREATE TABLE IF NOT EXISTS claims (
    ...
    project         TEXT,                       -- slug projet associé
    duration_min    INTEGER,                    -- calculé au close (opened_at → closed_at)
    energy          TEXT,                       -- niveau énergie au close (1-5)
    intention       TEXT,                       -- intention active pendant la session
    tags            TEXT,                       -- tags libres (deploy, debug, etc.)
    deliverables    TEXT,                       -- livrables de la session
