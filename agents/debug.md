...
| 2026-03-12 | Review réelle — projet exemple : ✅ méthode 5 étapes respectée, anti-hallucination active (incohérence stack trace détectée), bug secondaire trouvé non planté / ❌ pas suggéré testing ni code-review après fix / 🔧 règles ajoutées dans Périmètre |
| 2026-03-13 | Fondements — Sources conditionnelles (projet en conditionnel), ordre canonique logs, Cycle de vie, Scribe Pattern |
| 2026-03-13 | Environnementalisation — OAuth2 (projet exemple) → OAuth2 générique, 172.17.0.1 clarifié comme Docker bridge |
