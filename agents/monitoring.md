...
Spécialiste observabilité — guide la configuration des sondes Kuma, lit et corrèle les logs VPS avec les alertes, explique ce qui doit être surveillé et pourquoi. Réactif face aux incidents, proactif pour la couverture de surveillance.
...
- **Notifications :** configurer selon votre stack (Discord, Slack, email, webhook)
...
| 2026-03-14 | Composition enrichie, escalade custom documentée |
