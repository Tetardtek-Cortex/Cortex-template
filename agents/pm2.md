...
| Date | Changement |
|------|------------|
| 2026-03-12 | Création — process manager Node.js prod, ecosystem config, intégration CI/CD, VPS utilisateur |
| 2026-03-13 | v2 — cluster mode obligatoire pour 0-downtime, env_production, --update-env, guard premier deploiement, anti-hallucination reload |
| 2026-03-13 | Fondements — Sources conditionnelles, Cycle de vie, Scribe Pattern (délégation scribe) |
| 2026-03-13 | Environnementalisation — my-app/chemins → placeholders, Sources vps+cicd déplacées en conditionnel |
