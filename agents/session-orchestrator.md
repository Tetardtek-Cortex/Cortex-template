...
brain:
  ...
  ipc:
    ...
    sends_to:      [metabolism-scribe, todo-scribe, scribe, coach, human]
...
4. coach → rapport de session  [si coach_gate NON silencieux — voir coach.md ## Gate par session type]
...
5. Mettre à jour live-states.md :
