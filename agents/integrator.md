...
|------|------|---------------|-------------|
| WORK | repos projets (my-project, etc.) | Commit d'absorption multi-agents | `integrator:` |
...
| Date | Changement |
|------|------------|
| 2026-03-14 | Création — issu d'un sprint réel, rôle T2 formalisé, protocole séquence + anti-dérive |
