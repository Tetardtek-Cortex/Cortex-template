...
| 2026-03-12 | Review réelle — projet exemple : ✅ anti-hallucination (posé la question process manager), Node mismatch détecté, scope adapté / ❌ règle toolkit présente mais non appliquée, pas suggéré monitoring / 🔧 monitoring ajouté en Composition |
