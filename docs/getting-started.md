...
> Envie de comprendre le projet avant de fork ? → *(ajoutez votre URL story ici)*
...
- **Node.js 22+** — pour brain-ui (dashboard web)
...
Instance : mon-brain@<ta-machine>  [free]  kernel v0.9.2
Mode actif : prod
