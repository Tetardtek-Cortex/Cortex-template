...
- Les agents specialises (56 agents specialises)
...
KERNEL.md, CLAUDE.md, agents/. Aucune modification sans decision humaine. Session `edit-brain` requise.
...
- **Scribes** — scribe, todo-scribe, metabolism-scribe
- **Presences** — coach, secrets-guardian, helloWorld, session-orchestrator
- **Systeme** — key-guardian, pre-flight, brain-guardian
...
- **Detail technique** : wiki/ — session-lifecycle, patterns, vocabulary
