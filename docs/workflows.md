...
```
Charge l'agent optimizer
```

> 🟠 **pro**

Un agent unifie pour les 3 couches :
- Backend — async, memoire, event loop Node.js
- Database — N+1, index manquants, EXPLAIN
- Frontend — re-renders, bundle, lazy loading
